...
{
    // Strategy - Enables the exact behavior of a system to be selected either at run-time (dynamic)
    //      or at compile-time (static) 2) Also known as a policy (esp. in the C++ world).
